...
- Drop the line entirely if it does not contain any `-c` options in `arguments` field
...
the generated filename for the line. See next section for filename generation.
