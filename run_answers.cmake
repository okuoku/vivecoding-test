...
execute_process(COMMAND
    ...
    OUTPUT_FILE ${projroot}/rs_project_cmds.jsonl
)

execute_process(COMMAND
    ${Python_EXECUTABLE} ${myroot}/inject_preprocess.py
    -b check
    INPUT_FILE ${projroot}/rs_project_cmds.jsonl
    OUTPUT_FILE ${projroot}/rs_project_preprocess.jsonl
)

execute_process(COMMAND
    ${Python_EXECUTABLE} ${myroot}/exec_project.py
    INPUT_FILE ${projroot}/rs_project_preprocess.jsonl
    WORKING_DIRECTORY ${projroot}
)
